app.controller("encyclopediaListController", ['$rootScope','$scope','$httpService','$location','$q','$hostService',
    function($rootScope,$scope,$httpService,$location,$q,$hostService ) {
        $scope.moduleName = '咖啡百科编辑发布列表';
        changeClass('contentMenu','baikeEdite');
        ...
        $scope.clickEdit = function (id) {
            window.location.href = '#/encyclopediaEditorDetail?contentId='+id;
        }

        $scope.clickAdd = function(){
            window.location.href = '#/encyclopediaEditorDetail';
        };
